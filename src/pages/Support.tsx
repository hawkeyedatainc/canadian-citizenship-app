...
const contactCards = [
  ...
  },
  {
    ...
    value: "Independent Study Aid",
    hint: "Not affiliated with IRCC, the Government of Canada, or any government agency.",
  },
];

const supportTopics = [
  "App usage and study-flow questions",
  "Premium purchase or restore-purchase issues",
  "AI Focus Review or weak-topic review feedback",
  "Province or territory civics practice questions",
            ...
            <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
              <div>
                ...
                <h1 className="font-display text-4xl font-bold md:text-5xl">
                  Contact <span className="gradient-text">Canada Citizenship Prep 2026</span>
                </h1>
                <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
                  Need help with study features, premium access, AI Focus Review, privacy, or a content correction? Send a message and include only the details you choose to share.
                </p>
                <a
                  href="mailto:learn@hawkeyedata.ca?subject=Canada%20Citizenship%20Prep%202026%20Support"
              ...
              <div className="rounded-lg border border-border bg-background/60 p-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  For official citizenship information, always refer to IRCC and Government of Canada sources. We can help with this app, but we cannot provide official immigration decisions, official test questions, or legal advice.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="grid gap-6 md:grid-cols-[1fr_0.9fr]">
            ...
            >
              ...
              <p className="text-muted-foreground">
                The app does not collect your name, email, account profile, study data, answers, flags, test date, province or territory, or AI Focus Review activity.
              </p>
